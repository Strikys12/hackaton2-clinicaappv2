...
public class Turno {
    ...
    public void setPaciente(Paciente paciente) {
        if (paciente == null) {
            throw new IllegalArgumentException("El paciente del turno no puede ser nulo.");
        }
    ...
    public void setMedico(Medico medico) {
        if (medico == null) {
            throw new IllegalArgumentException("El médico del turno no puede ser nulo.");
        }
        this.medico = medico;
    }
